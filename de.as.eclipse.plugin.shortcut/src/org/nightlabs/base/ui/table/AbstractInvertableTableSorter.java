...
public abstract class AbstractInvertableTableSorter<T> extends InvertableSorter<T> {
    ...
    private final InvertableSorter<T> inverse = new InvertableSorter<T>() {
        ...
        @Override
        protected int compareTyped(Viewer viewer, T e1, T e2) {
            return (-1) * AbstractInvertableTableSorter.this.compare(viewer, e1, e2);
        }

        @Override
        protected AbstractInvertableTableSorter<T> getInverseSorter() {
    ...
    @Override
    protected InvertableSorter<T> getInverseSorter() {
        return this.inverse;
    }
